 ...
 * @version 创建时间：2016年6月20日 下午2:19:47 
 * note
 */
public class ValleyResponse extends SearchResponse{
	public ValleyResponse(InternalSearchResponse internalResponse, String scrollId, int totalShards, int successfulShards, long tookInMillis, ShardSearchFailure[] shardFailures) {
